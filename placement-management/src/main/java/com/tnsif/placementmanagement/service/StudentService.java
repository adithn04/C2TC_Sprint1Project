    ...
    public Student updateStudent(Long id, Student updatedStudent) {
        return studentRepository.findById(id)
                .map(student -> {
                    ...
                    // Update email through the linked User object
                    if (student.getUser() != null && updatedStudent.getUser() != null) {
                        student.getUser().setEmail(updatedStudent.getUser().getEmail());
                    }
