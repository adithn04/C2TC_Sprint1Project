...
public class PlacementService {
    ...
    public Optional<Placement> getPlacementById(Long id) { return placementRepository.findById(id); }
    public Placement createPlacement(Placement placement) { return placementRepository.save(placement); }
    public Placement updatePlacement(Long id, Placement updatedPlacement) {
        return placementRepository.findById(id)
                .map(placement -> {
                    ...
                    placement.setRole(updatedPlacement.getRole());
                    placement.setDateOfPlacement(updatedPlacement.getDateOfPlacement());
                    placement.setStudent(updatedPlacement.getStudent());
                    placement.setCollege(updatedPlacement.getCollege());
                    return placementRepository.save(placement);
                }).orElseThrow(() -> new RuntimeException("Placement not found"));
    }
    public void deletePlacement(Long id) { placementRepository.deleteById(id); }
}
